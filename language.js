...
(() => {
  ...
  function injectSwitcher() {
    ...
    style.textContent = '.pure20-lang-switch{display:inline-flex;align-items:center;gap:2px;border:1px solid currentColor;padding:2px;margin-left:10px;vertical-align:middle;white-space:nowrap}.pure20-lang-switch button{appearance:none;border:0;background:transparent;color:inherit;font:inherit;font-size:10px;line-height:1;letter-spacing:.08em;padding:7px 8px;cursor:pointer}.pure20-lang-switch button[aria-pressed="true"]{background:#111;color:#fff}@media(max-width:600px){.pure20-lang-switch{right:8px!important;top:8px!important;margin-left:0}.pure20-lang-switch button{padding:7px 6px;font-size:9px}}';
